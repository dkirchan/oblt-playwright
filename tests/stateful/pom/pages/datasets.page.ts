...
export default class DatasetsPage extends AbstractPage {
  ...
  private readonly activeDatasetsNumber = () =>
    this.page.locator("xpath=(//h3)[4]");
  private readonly estimatedData = () => this.page.locator("xpath=(//h3)[5]");
  private readonly table = () => this.page.locator("xpath=//tbody");
  private readonly degradedDocsColumn = () =>
    this.page.locator("xpath=//tbody//tr[1]//td[5]");
